...
local hiddenped = Config.Locations
...
QBCore.Functions.CreateCallback('bubba-moneywash:server:pedcoords', function(source, cb)
...
RegisterNetEvent("bubba-moneywash:server:sellthem",function(amount)
    local Player = QBCore.Functions.GetPlayer(source)
